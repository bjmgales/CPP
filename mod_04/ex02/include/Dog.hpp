...
/*   Updated: 2023/05/29 14:17:07 by bgales           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    /**
     * Default constructor.
     * Creates a Dog object with the default type "Dog" and allocates a Brain.
     */
    Dog();

    /**
     * Destructor.
     * Cleans up the Dog object and deletes the Brain.
     */
    ~Dog();
