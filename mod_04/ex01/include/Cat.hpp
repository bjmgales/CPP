...
/*   Updated: 2023/05/29 14:17:24 by bgales           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    /**
     * Default constructor.
     * Creates a Cat object with the default type "Cat" and allocates a Brain.
     */
    Cat();

    /**
     * Destructor.
     * Cleans up the Cat object and deletes the Brain.
     */
    ~Cat();
